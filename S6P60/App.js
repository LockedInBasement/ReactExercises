class Clicker extends React.Component {
    ...
    handleClick3 = () =>{
        ...
        console.log(prevState.number3 + " w metodzie handleClick3");
    }

    render(){
        //console.log(this.state.number1 + " w metodzie render");
        //console.log(this.state.number2 + " w metodzie render");
        console.log(this.state.number3 + " w metodzie render");
        return(
            <div>
                <button onClick={this.handleClick1}>Podbij o 1</button>
                <h1>{this.state.number1}</h1>'
                <button onClick={this.handleClick2}>Podbij o 2</button>
